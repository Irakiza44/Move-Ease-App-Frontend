...
@Component({
  selector: 'app-move-in-citizen',
  templateUrl: './move-in-citizen.component.html',
  styleUrls: ['./move-in-citizen.component.css'],
})
export class MoveInCitizenComponent implements OnInit {
  contacts: any[] = [];
  ...
  loadContacts(): void {
    this.adminService.getContacts().subscribe((response) => {
      this.contacts = response.contacts; // fix the typo here
